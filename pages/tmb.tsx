...
// Utility: แปลง unknown เป็น string (กัน type error)
...
export default function TMB() {
  ...
  useEffect(() => {
    ...
    else if (currentTab === 'solo') file = 'tmb-encounters-solo.yaml';
    else if (currentTab === 'tyrants') file = 'tmb-tyrants.yaml';
    else if (currentTab === 'loots') file = 'tmb-loots.yaml';
    else file = 'tmb-encounters.yaml';
    fetch(`/data/Core/${file}`)
      .then(res => res.text())
...
<aside className="hidden md:flex flex-col w-64 bg-gray-900 h-screen sticky top-0">
  <div className="flex flex-col gap-2 px-6 py-8">
    ...
    {/* เมนูหลัก (เลือก version ของ Too Many Bones) */}
    {[
          ...
          <div className="fixed inset-0 z-50 bg-black bg-opacity-60 flex items-center justify-center">
            <div className="bg-white rounded-lg shadow-lg w-full max-w-lg p-6 relative">
              ...
              <div
                ...
                style={{ pointerEvents: "none" }} // ไม่ให้ซ้อนทับปุ่มปิด
                >
