...
export default function TMB() {
  ...
  const activeMenu = "undertow"; // เปลี่ยนเป็น "undertow" หรือ "unbreakable" ในไฟล์แต่ละอัน
  ...
  useEffect(() => {
    ...
    fetch(`/data/Undertow/${file}`) // เปลี่ยน /Core/ เป็น /Undertow/ หรือ /Unbreakable/ ในแต่ละไฟล์
      .then(res => res.text())
